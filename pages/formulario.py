...
def agregar_encuesta():
    ...
    st.radio("Tipo", ["Residencial", "Comercial"], horizontal=True, key='Tipo')
    st.number_input("Edad", value=st.session_state['Edad'], key='Edad')

    st.radio("1 ¿Usted considera que el tiempo de entrega de su factura, hasta la fecha límite de pago de la misma, es adecuado?", [0,5,4,3,2,1], horizontal=True, key='pregunta1')
    st.radio("2 ¿Cómo califica la información contenida en la factura de pago en términos de facilidad para comprenderla?", [0,5,4,3,2,1], horizontal=True, key='pregunta2')
    st.text_input("2.1 Si la respuesta es 1 o 2 Especifique su razón principal:", key='pregunta2_1')
    st.radio("3 ¿Conoce los sitios de pago de su factura?", ["SI", "NO"],horizontal=True, key='pregunta3')
    st.text("4 La atención que Usted recibe en nuestros puntos, ha sido:")
    st.radio("4.1 Amable", [0,5,4,3,2,1], horizontal=True, key='pregunta4_1')
    st.radio("4.2 Ágil", [0,5,4,3,2,1], horizontal=True, key='pregunta4_2')
    st.radio("4.3 Oportuna", [0,5,4,3,2,1], horizontal=True, key='pregunta4_3')
    st.radio("5 ¿Durante el año pasado, Usted presentó una petición, una queja, reclamo, sugerencia o una denuncia (PQRS)?", ["SI", "NO"],horizontal=True, key='pregunta5')
    st.radio("5.1 ¿La orientación que recibió a su trámite, fue:", [0,5,4,3,2,1], horizontal=True, key='pregunta5_1')
    st.radio("5.2 ¿Cómo califica la respuesta a su PQRS?", [0,5,4,3,2,1], horizontal=True, key='pregunta5_2')
    st.radio("6 ¿Ha solicitado revisión interna en su inmueble?", ["SI", "NO"],horizontal=True, key='pregunta6')
    st.radio("6.1 Si la respuesta es SI ¿cómo califica la atención recibida?", [0,5,4,3,2,1], horizontal=True, key='pregunta6_1')
    st.radio("7 ¿Durante el año 2024 le suspendieron el servicio de acueducto?", ["SI", "NO"],horizontal=True, key='pregunta7')
    st.radio("7.1 Si la respuesta es SI   y teniendo en cuenta que, por normatividad, EMPOPASTO cuenta con 24 horas hábiles para la reinstalación del servicio ¿Cómo califica usted el tiempo entre la suspensión y la reinstalación?", [0,5,4,3,2,1], horizontal=True, key='pregunta7_1')
    st.radio("8 Califique si las Instalaciones de Empopasto S.A. E.S.P. son adecuadas para atender a los usuarios.", [0,5,4,3,2,1], horizontal=True, key='pregunta8')
    st.radio("9 ¿Usted se ha comunicado con EMPOPASTO a través del canal telefónico? Línea 116", ["SI", "NO"],horizontal=True, key='pregunta9')
    st.radio("9.1 Si la respuesta es SI ¿cómo califica la atención recibida?", [0,5,4,3,2,1], horizontal=True, key='pregunta9_1')
    st.radio("10 ¿Cómo califica la calidad de agua que recibe de EMPOPASTO?", [0,5,4,3,2,1], horizontal=True, key='pregunta10')
    st.radio("11 ¿Empopasto le brinda información de manera anticipada sobre las suspensiones del servicio en su sector? ", ["SI", "NO"],horizontal=True, key='pregunta11')
    st.radio("11.1 Si la respuesta es Si, califique si la información y el tiempo de aviso previo a la suspensión del servicio de agua son adecuados", [0,5,4,3,2,1], horizontal=True, key='pregunta11_1')
    st.radio("12 Considera Usted, que la continuidad del servicio que presta EMPOPASTO es:", [0,5,4,3,2,1], horizontal=True, key='pregunta12')
    st.radio("13 La presión de agua en su inmueble o en su vivienda es?", [0,5,4,3,2,1], horizontal=True, key='pregunta13')
    st.radio("14 ¿Cómo califica la oportunidad y organización de los trabajos realizados cuando se presenta un daño de acueducto o alcantarillado?", [0,5,4,3,2,1], horizontal=True, key='pregunta14')
    st.text_input("14.1 Si la respuesta es 1 o 2 Especifique su razón principal:", key='pregunta14_1')
    st.radio("15 Se ha visto afectado por los trabajos adelantados por EMPOPASTO?", ["SI", "NO"],horizontal=True, key='pregunta15')
    st.text_input("15.1 Si la respuesta es Si, especifique su respuesta", key='pregunta15_1')
    st.radio("16 ¿Cómo califica la labor de mantenimiento y limpieza en cámaras y sumideros para evitar taponamientos y reboses?", [0,5,4,3,2,1], horizontal=True, key='pregunta16')
    ...
    st.radio("19 ¿Conoce los servicios que presta EMPOPASTO en su página Web?", ["SI", "NO"],horizontal=True, key='pregunta19')
    ...
    st.radio("20 ¿Cómo califica usted las actividades que realiza Empopasto de carácter social y ambiental, que benefician y mejoran la calidad de vida de la comunidad?", [0,5,4,3,2,1], horizontal=True, key='pregunta20')
    st.radio("21 ¿Cómo considera usted la gestión actual de EMPOPASTO?", [0,5,4,3,2,1], horizontal=True, key='pregunta21')
    st.text_input("22 Que sugerencias tiene para Empopasto", key='pregunta22')
    st.radio("23 Encuestadora", ["Leni Valentina Patiño", "Daniela Sofia Coral Escobar", "Maritza Patiño", "Amalia Coral", "Monica Patiño", "Leidy Ximena Lasso", "Luisa María Arteaga Lasso", "Edison Portilla Luna", "Milena Lucero"],horizontal=True, key='pregunta23')
